...
# original: 10, 100
# GFP_mCherry_colocalization = cf.in_contact(mCherry_o_n_segmented, in_channel = ['max_mCherry', 'max_GFP'], out_channel = ['colocalization_mCherry', 'colocalization_GFP'])
running_render = rdr.Kristen_render(mCherry_o_n_segmented, in_channel=['name pattern',
                                                               'max_mCherry',
                                                               'max_mCherry_binary',
                                                               'GFP',
                                                               'mCherry'],
                                   out_channel='qualifying_regression_stats',
                                   save=True)
