...
stabilized_GFP = wrapped_image_proc_steps.gamma_stabilize(named_source, in_channel='GFP', min='min', alpha_clean=.5)

smoothed_GFP = wrapped_image_proc_steps.smooth(stabilized_GFP, in_channel='GFP', smoothing_px=.5)

stabilized_mCh = wrapped_image_proc_steps.gamma_stabilize(smoothed_GFP, in_channel='mCherry', min='min', alpha_clean=.5)

smoothed_mCh = wrapped_image_proc_steps.smooth(stabilized_mCh, in_channel='mCherry', smoothing_px=.5)

med_norm_GFP = wrapped_image_proc_steps.locally_normalize(smoothed_mCh,
                                                          in_channel='GFP',
                                                          )

med_norm_mCh = wrapped_image_proc_steps.locally_normalize(med_norm_GFP,
                                                          in_channel='mCherry',
                                                          )

projected_GFP = wrapped_image_proc_steps.max_projection(med_norm_mCh,
                                                        in_channel='GFP',
